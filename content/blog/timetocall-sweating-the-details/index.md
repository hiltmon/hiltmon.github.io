...
*[TimeToCall](https://hiltmon.com/timetocall/) is a simple, universal iOS application I developed to help people choose the best time to call when calling internationally. This is [**part 6** in a series of posts](https://hiltmon.com/blog/categories/timetocall/) about the thinking and work done. My goal is to share just how much effort it really does take to craft an iPhone app and ship it. I hope this series helps you to understand why it costs so much and takes so long to create beautiful software. [Back to part 5](https://hiltmon.com/blog/2013/02/02/timetocall-good-and-bad-times-to-call/) or [start at part 1 first](https://hiltmon.com/blog/2013/01/29/timetocall-the-effort-and-the-return/).*
...
Here a some of the details in [TimeToCall](https://hiltmon.com/timetocall/) that were sweated, and solutions chosen.
...
I can’t have my users waiting that long for the GPS every time they launch [TimeToCall](https://hiltmon.com/timetocall/).
