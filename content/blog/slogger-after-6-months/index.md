...
I have been using [Brett Terpstra's][brettterpstra] ([@ttscoff][twitter]) [Slogger][brettterpstra 2] for the last six months, and I think it's time to review it. Slogger is a script and a set of plugins that log your online activity each day into [Day One][linksynergy], the best journaling application for OS X, or in Markdown files if you prefer. It's a core part of my [Backing up your Online Life](https://hiltmon.com/blog/2013/03/14/backup-your-online-life/) process.
...
Let us look at my Friday, April 19th, in [Day One][linksynergy], in order from top to bottom, [click the image for a full-size version](https://hiltmon.com/images/slogger-review-1.jpg). It contains:

[{{< figure src="images/slogger-review-1.jpg" width=341 height=393 class="image-right" >}}](https://hiltmon.com/images/slogger-review-1.jpg)
...
If we choose the Google Analytics for hiltmon.com, we get the image on the left, [click for larger version](https://hiltmon.com/images/slogger-review-2.jpg). For each day, I can see how many page views and visitors the site got, where those visitors came from, and the top 10 most popular articles on the site.
...
[{{< figure src="images/slogger-review-3.jpg" width=255 height=295 class="image-right" >}}](https://hiltmon.com/images/slogger-review-3.jpg)

If we choose the tweets item, I see all the tweets I made on that day, [click for larger version](https://hiltmon.com/images/slogger-review-3.jpg). Seems that I did not get any retweets or favorites on that day.
