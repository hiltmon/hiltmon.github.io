...
{{< figure src="images/indie-writing-1.jpg" width=612 height=360 >}}
...
{{< figure src="images/indie-writing-2.jpg" width=700 height=452 >}}
...
{{< figure src="images/indie-writing-3.jpg" width=507 height=484 >}}
...
{{< figure src="images/indie-writing-4.jpg" width=512 height=343 >}}
...
I use Adobe's Photoshop or Illustrator to create original art, for example for my  [TimeToCall](https://hiltmon.com/timetocall/) application, but I find them too heavy and slow for quick blog use. For article art, I grab some screenshots from my iPhone or Mac and use [Acorn][acorn] to composite, add text, resize, trim and export the final art for the blog. [Acorn][acorn] by Gus Mueller at [Flying Meat][56] is quick to launch, easy to use and very powerful without seeming heavy.
