...
date: 2013-03-19T19:23:00-04:00
tags: [ Web ]
---
...
It looks like Google is about to kill off [Feedburner](http://feedburner.google.com), so its best if we get started on the transition. Going forward, I'll be using [Octopress'](https://github.com/octopress/octopress) built-in RSS feed. Please re-subscribe to **The Hiltmon RSS Feed** at:
...
The feed at Feedburner will continue to work for a while, then redirect you to the old one (it picks up the data directly from my feed anyway). And you can always get notified of new posts by following me at [Twitter](https://twitter.com/hiltmon) or [Facebook](https://www.facebook.com/hiltmoncom).
